...
public interface LengthUnitSoap {
    ...
    @RequestWrapper(localName = "ChangeLengthUnit", targetNamespace = "http://www.webserviceX.NET/", className = "amazon.ChangeLengthUnit")
    @ResponseWrapper(localName = "ChangeLengthUnitResponse", targetNamespace = "http://www.webserviceX.NET/", className = "amazon.ChangeLengthUnitResponse")
